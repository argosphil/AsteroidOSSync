...
public class AsteroidUUIDS {
    ...
    public static final UUID SHELL_SERVICE_UUID = UUID.fromString("AAAAAAAB-0000-0000-0000-00A57E401D05");
    public static final UUID SHELL_TERMINAL_SEND = UUID.fromString("AAAAAAAC-0000-0000-0000-00A57E401D05");
    public static final UUID SHELL_TERMINAL_RECV = UUID.fromString("AAAAAAAD-0000-0000-0000-00A57E401D05");
}
